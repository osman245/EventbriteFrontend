    ...
    <div className="w-70 my-5 mt-4 container">
        ...
        <i className="checkmark ml-5">✓</i>
         ...
         <div className="card-body">   
             ...
             <h5 className= " text-center ">We received your purchase request;
                we'll be in touch shortly!</h5>
                <div className="d-flex justify-content-center"> <a href="/" className="btn btn-success text-white">HomePage</a></div>
             </div>
         </div>  
        </div>
   );
